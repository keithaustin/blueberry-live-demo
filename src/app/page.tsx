...
export default function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center p-8
      ...
      <a href="https://keithaustin.dev/"
        className="absolute top-2 left-2 font-semibold underline hover:no-underline">
          Back to Portfolio
      </a>
      ...
      <section className="input text-center mb-4 min-w-[95%]">
        <form onSubmit={(e) => handleSubmit(e)}>
          <textarea
            className="rounded-lg shadow-xl font-mono min-h-[200px] min-w-[340px]
              md:min-w-[440px] lg:min-w-[640px] md:min-h-[260px] lg:min-h-[500px]
      ...
      <section className="output mb-4">
        <div className="output-pane bg-teal-950/30 min-h-[128px]
